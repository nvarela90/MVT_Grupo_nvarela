...
#     return HttpResponse(template_renderizado)
    return render(request, 'home/ver_personas.html', {'persona': persona})
...
def crear_familiar(request):
    ...
    # familiar.save()
    # familiar = Familiar(nombre=nombre, apellido=apellido, edad=random.randrange(1,99), fecha_nacimiento=datetime.now())
    familiar1 = Familiar(nombre='Diego', apellido='Maradona', edad=60, fecha_nacimiento=datetime.now())
    familiar2 = Familiar(nombre='Juan Román', apellido='Riquelme', edad=44, fecha_nacimiento=datetime.now())
    familiar3 = Familiar(nombre='Roberto', apellido='Carlos', edad=random.randrange(1,99), fecha_nacimiento=datetime.now())
    familiar1.save()
    familiar2.save()
    familiar3.save()
    
    template = loader.get_template('home/crear_familiar.html')
    template_renderizado = template.render()
...
def ver_familiar(request):
    ...
    return render(request, 'home/ver_familiar.html', {'familiar': familiar})
